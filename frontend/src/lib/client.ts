...
export function Environment(name: string): BaseURL {
  return `https://${name}-booking-system-73bi.encr.app`;
}
...
/**
 * Client is an API client for the booking-system-73bi Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "booking-system-73bi-Generated-TS-Client (Encore/v1.28.0)",
    };
